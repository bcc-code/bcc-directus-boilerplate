...
export class OAuth2 {
    ...
    private loadAccessToken(response: { access_token: string, refresh_token: string, expires_in: number }) {
    ...
    async request(method: "GET"|"POST"|"PATCH"|"DELETE", path: string, { body, params }: { body?: any, params?: any }) {
        if (this.isExpired) {
